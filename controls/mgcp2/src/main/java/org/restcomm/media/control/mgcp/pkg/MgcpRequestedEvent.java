...
public class MgcpRequestedEvent {
    ...
    public MgcpRequestedEvent(BigInteger requestId, String packageName, String eventType, MgcpActionType action, int connectionId, String... parameters) {
    ...
    public MgcpRequestedEvent(BigInteger requestId, String packageName, String eventType, MgcpActionType action) {
